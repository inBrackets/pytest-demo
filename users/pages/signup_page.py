...
class SignupPage(BasePage):
    ...
    # Locators
    @property
    def _account_info_heading(self):
    ...
    @property
    def _account_created_heading(self):
    ...
    @property
    def _delete_account_link(self):
        return self._page.locator("a[href='/delete_account']")

    @property
    def _account_deleted_heading(self):
